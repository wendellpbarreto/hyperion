...
<div id="all">
  <div id="menu">        
   <a href="index.php"  style="margin-left:210px;">Home</a>
        ...
        <span></span>
        <a href="donation.php" class="active">Donation</a> </div>
</div>
...
<td width="733"> 
	<div id="box_right"> 
    	    	<table border="0" cellspacing="0" cellpadding="0">
 				  <tr valign="top">
                 <td><img src="img/donation.png" alt="" style="margin-left:65px;margin-bottom:10px;"/></td>
        ...
        <tr valign="top">
                    ...
                    <td width="480" height="620">
                    <div style="margin-left:65px;">
                    


<?php include('donationtxt.php')?>
