...
<title>L2unnamed.com</title>
<script src="Scripts/swfobject_modified.js" type="text/javascript"></script>
</head>

<body onload="scroll(); return false;">
...
<div id="all">
  <div id="menu">        
   <a href="index.php"  style="margin-left:210px;">Home</a>
        ...
        <span></span>
        <a href="information.php" class="active" style="margin-right:265px;">Information</a>
...
<td width="733"> 
	<div id="box_right"> 
    	    	<table border="0" cellspacing="0" cellpadding="0">
 				  <tr valign="top">
                 <td><img src="img/information.png" alt="" style="margin-left:65px;margin-bottom:10px;"/></td>
